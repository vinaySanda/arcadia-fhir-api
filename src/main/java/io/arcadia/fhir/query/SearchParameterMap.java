...
/**
 * <p>
 * {@link SearchParameterMap} extends {@link LinkedHashMap}
 * </p>
 * 
 * <p>
 * Used to hold FHIR search parameters.
 * </p>
 * 
 * @author Admin
 *
...
public class SearchParameterMap extends LinkedHashMap<String, List<List<? extends IQueryParameterType>>> {
	 ...
	 * @param theAnd  Multiple mandatory parameters
	 */
	 ...
	 * 
	 * @param theName Name of the parameter
	 * @param theOr   Multiple optional parameters
	 */
	...
	/**
	 * 
	 * @param theInclude Resource to be included
	 */
	...
	public enum EverythingModeEnum {
		 ...
		 */
		ENCOUNTER_INSTANCE(false, true, true), ENCOUNTER_TYPE(false, true, false), PATIENT_INSTANCE(true, false, true),
